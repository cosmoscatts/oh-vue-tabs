...
<template>
  <div relative flex-inline items-center h-34px px-24px m="r-[-18px]" cursor-pointer
    ...
    <div absolute left-0 bottom-0 h-full w-full of-hidden>
      <ChromeShape :is-dark="isDark" :is-active="isActive" :is-hover="isHover" :primary-color="primaryColor"
    ...
    <div absolute right="[-2px]" z-2 w-20px scale-x-5 h-16px bg="[#1f2225]" op-100 transition="opacity 0.3s ease-in-out"
      :class="{
